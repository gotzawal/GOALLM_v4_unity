...
public class Item
{
    ...
    {
        Name = name;
        Behaviors = new Dictionary<string, Dictionary<string, object>>(behaviors, StringComparer.OrdinalIgnoreCase);
        State = state != null ? new Dictionary<string, object>(state, StringComparer.OrdinalIgnoreCase) : new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
    }
    ...
    public Item Copy()
    {
        return new Item(Name, new Dictionary<string, Dictionary<string, object>>(Behaviors, StringComparer.OrdinalIgnoreCase), new Dictionary<string, object>(State, StringComparer.OrdinalIgnoreCase));
    }
